...
```
    ...
    ## # A tibble: 4,999 × 6
    ##     ...1 description         medical_special… sample_name transcription keywords
    ##    <dbl> <chr>               <chr>            <chr>       <chr>         <chr>   
    ##  1     0 "A 23-year-old whi… Allergy / Immun… Allergic R… "SUBJECTIVE:… allergy…
    ##  2     1 "Consult for lapar… Bariatrics       Laparoscop… "PAST MEDICA… bariatr…
    ##  3     2 "Consult for lapar… Bariatrics       Laparoscop… "HISTORY OF … bariatr…
    ##  4     3 "2-D M-Mode. Doppl… Cardiovascular … 2-D Echoca… "2-D M-MODE:… cardiov…
    ##  5     4 "2-D Echocardiogra… Cardiovascular … 2-D Echoca… "1.  The lef… cardiov…
    ##  6     5 "Morbid obesity.  … Bariatrics       Laparoscop… "PREOPERATIV… bariatr…
    ##  7     6 "Liposuction of th… Bariatrics       Liposuction "PREOPERATIV… bariatr…
    ##  8     7 "2-D Echocardiogra… Cardiovascular … 2-D Echoca… "2-D ECHOCAR… cardiov…
    ##  9     8 "Suction-assisted … Bariatrics       Lipectomy … "PREOPERATIV… bariatr…
    ## 10     9 "Echocardiogram an… Cardiovascular … 2-D Echoca… "DESCRIPTION… cardiov…
...
![](README_files/figure-gfm/barplot-1.png)<!-- --> The distribution is
not at all uniform
...
![](README_files/figure-gfm/token-transcription-1.png)<!-- --> There are
a lot of stopwords herem non-specific to medical text.
...
![](README_files/figure-gfm/unnamed-chunk-3-1.png)<!-- --> Removing the
stopwords and numbers gives us a much clear idea about it
...
![](README_files/figure-gfm/unnamed-chunk-6-1.png)<!-- --> Top20
trigrams seemed to return more related to medical
