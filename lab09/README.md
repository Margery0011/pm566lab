...
```
    ...
    ##     fun1() 240.542 309.9795 333.23516 339.063 351.7920  417.792   100
    ##  fun1alt()  19.209  20.9800  39.83236  21.772  23.5635 1737.209   100
...
```
    ...
    ## Unit: microseconds
    ##        expr     min       lq     mean   median      uq      max neval
    ##     fun2(x) 743.959 764.9170 850.8335 794.0005 859.542 2200.209   100
    ##  fun2alt(x)  94.584  98.5425 127.2441 102.8550 115.396 1932.251   100
